        ...
        <div className="flex items-center gap-4 md:gap-6">
          ...
          {user ? (
            <div className="flex items-center gap-4">
              ...
              <Link to="/settings" className="p-2.5 rounded-xl bg-gray-100 dark:bg-[#1E1E1E] hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors text-gray-600 dark:text-gray-300" title="Settings">
